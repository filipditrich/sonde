...
test('derived artifact ids are UUID v5 over their semantic keys', () => {
	...
	expect(String(issuerSicClassificationIdFrom('0000320193', '3571', sha))).toBe(String(issuerSicClassificationIdFrom('0000320193', '3571', sha)));
});
